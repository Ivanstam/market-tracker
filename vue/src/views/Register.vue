...
<template>
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight">Register a new account</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <form class="space-y-3" @submit='register'>
      ...
      <div>
        <label for="name" class="block text-sm font-medium leading-6">First and last name</label>
        <div class="mt-2">
